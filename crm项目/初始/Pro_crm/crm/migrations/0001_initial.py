# -*- coding: utf-8 -*-
# Generated by Django 1.11.21 on 2019-07-03 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Campus', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('re_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cl_record', to='crm.ClassList', verbose_name='班级')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('course', multiselectfield.db.fields.MultiSelectField(choices=[('Linux', 'Linux中高级'), ('PythonFullStack', 'Python高级全栈开发')], max_length=21, verbose_name='咨询课程')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, choices=[('Linux', 'Linux中高级'), ('PythonFullStack', 'Python高级全栈开发')], default='N/A', max_length=64, null=True, verbose_name='课程名')),
        ...
        migrations.AddField(
            ...
            name='confirm_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirms', to='crm.UserProfile', verbose_name='确认人'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='consultant',
        ...
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='crm.UserProfile', verbose_name='销售'),
        ),
        migrations.AddField(
            model_name='customer',
            name='introduce_from',
        ...
        migrations.AddField(
            ...
            name='recorder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.UserProfile', verbose_name='记录者'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='te_record', to='crm.UserProfile', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='crm.UserProfile', verbose_name='跟进人'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
